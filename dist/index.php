...
<html>
  <head>
    ...
    <link rel="stylesheet" href="src.be7f595a.css">
  </head>
  <body>
    ...
    <div class="search arrow">
      ...
      <div class="nav desktopFlex"><a href="articles.php">Articles</a><a href="top100.php">Nos classements</a></div>
    ...
    <div class="mainPage">
      <div class="backdrop">
        ...
        <div class="backdrop-img"><a href="https://en.calameo.com/read/005588257917038639670" target="_blank"><img src="uadv-couv.dc3c3668.jpg"></a></div>
      ...
      <div class="mainPageContainerarticles">
        <div class="articleContainer"><a class="articleContainerLink" href="page-article.php">
            <div class="articleContainer-article"><img class="articleContainer-article-img" src="background.jpg">
        ...
        <div class="articleContainer">
          <div class="articleContainer-article"><a class="articleContainerLink" href="page-article.php"><img class="articleContainer-article-img" src="background.jpg">
              <div class="articleContainer-article-titleContainer">
                <h3 class="articleContainer-article-titleContainer-title">Ceci est l'article 1 et efe koefk okapz </h3>
                <div class="articleContainer-article-details">
                  <p class="articleContainer-article-details-date">14 novembre 2018 -</p>
        ...
        <div class="bonPlansContainer">
          <div class="bonPlansContainer-main"><a class="bonPlanContainer-a" href="#">
              <div class="recommandationElement">
                <div class="background"><img class="backgroundImg" src="background.jpg" alt="backgound hotel"></div>
      ...
      <div class="mainPage-twitterFeed">
        ...
        <div class="tweetercontainer">
          ...
          <?php echo $data['keywordID'].' et '.$data['keyword']; ?>
            <a class="twitter-timeline" href="https://twitter.com/<?= $data['keyword'];?>">Tweets by <?php echo $data['keyword'];?></a>
            <a href="delete.php?id=<?= $data["keywordID"]?>">Supprimer</a>
          <?php endforeach; ?>
        </div>
      </div>
    </div>
